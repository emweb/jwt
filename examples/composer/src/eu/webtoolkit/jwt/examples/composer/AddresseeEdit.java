...
{
	/**
	 * Create a new addressee edit with the given label. finalructs
	 * also a widget to hold the label in the labelParent. The label will be
	 * hidden and shown together with this field.
	 */
	public AddresseeEdit(final String labelMsg, WContainerWidget parent, WContainerWidget labelParent)
	{
		super(parent);
