...
The example uses the `lib/javax/javamail/geronimo-javamail_1.4_provider-*.jar` jar
...
to implicitly include the `geronimo-javamail_1.4_provider-*.jar` jar files. This can
...
project, the `geronimo-javamail_1.4` dependency is scoped as "provided".
