...
class Media extends TopicWidget {
	...
	WWidget MediaPlayerVideo() {
		...
		player.playbackPaused().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Video paused</p>");
			}
		});
		player.ended().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Video ended</p>");
			}
		});
		player.volumeChanged().addListener(this, new Signal.Listener() {
			public void trigger() {
	...
	WWidget Sound() {
		...
		final WText out = new WText(container);
		playButton.clicked().addListener(this, new Signal.Listener() {
			public void trigger() {
				sound.play();
	...
	WWidget Audio() {
		...
		audio.setAlternativeContent(new WText(
				"You don't have HTML5 audio support!"));
		final WText out = new WText(container);
		audio.playbackStarted().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Audio playing</p>");
			}
		});
		audio.playbackPaused().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Audio paused</p>");
			}
		});
		audio.ended().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Audio ended</p>");
			}
		});
		audio.volumeChanged().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Volume changed</p>");
			}
		});
	...
	WWidget Video() {
		...
		final WText out = new WText(container);
		video.playbackStarted().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Video playing</p>");
			}
		});
		video.playbackPaused().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Video paused</p>");
			}
		});
		video.ended().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Video ended</p>");
			}
		});
		video.volumeChanged().addListener(this, new Signal.Listener() {
			public void trigger() {
				out.setText("<p>Volume changed</p>");
			}
		});
