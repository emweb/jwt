...
class LeafletMapExample extends WContainerWidget {
	private static Logger logger = LoggerFactory
			.getLogger(LeafletMapExample.class);
	...
	private void addEmwebLogoMarker() {
		WImage emwebLogo = new WImage(new WLink(
				"https://www.emweb.be/css/emweb_small_filled.png"));
		emwebLogo.setInline(false);
		emwebLogo.resize(new WLength(118), new WLength(32));
		WLeafletMap.WidgetMarker emwebMarker = new WLeafletMap.WidgetMarker(
				EMWEB_COORDS, emwebLogo);
	...
	private static final WLeafletMap.Coordinate EMWEB_COORDS = new WLeafletMap.Coordinate(
			50.906901, 4.655973);
}
