...
To install the two artifacts in your local repository, do:
    ...
    mvn install:install-file -Dfile=dist/jwt-4.13.3.jar -DpomFile=jwt-4.13.3.pom
    mvn install:install-file -Dfile=dist/jwt-auth-4.13.3.jar -DpomFile=jwt-auth-4.13.3.pom
