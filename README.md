...
To install the two artifacts in your local repository, do:
    ...
    mvn install:install-file -Dfile=dist/jwt-4.14.1.jar -DpomFile=jwt-4.14.1.pom
    mvn install:install-file -Dfile=dist/jwt-auth-4.14.1.jar -DpomFile=jwt-auth-4.14.1.pom
