...
To install the two artifacts in your local repository, do:
    ...
    mvn install:install-file -Dfile=dist/jwt-4.12.5.jar -DpomFile=jwt-4.12.5.pom
    mvn install:install-file -Dfile=dist/jwt-auth-4.12.5.jar -DpomFile=jwt-auth-4.12.5.pom
