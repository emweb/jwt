...
public class WSuggestionPopup extends WCompositeWidget {
	...
	private void defineJavaScript() {
		...
		app.doJavaScript("new Wt3_1_8.WSuggestionPopup("
	...
	static String wtjs1(WApplication app) {
		...
		if ("ctor.WSuggestionPopup".indexOf(".prototype") != -1) {
			return "Wt3_1_8.ctor.WSuggestionPopup = " + s + ";";
		} else {
			if ("ctor.WSuggestionPopup".substring(0, 5).compareTo(
					"ctor.".substring(0, 5)) == 0) {
				return "Wt3_1_8." + "ctor.WSuggestionPopup".substring(5)
						+ " = " + s + ";";
			} else {
				return "Wt3_1_8.ctor.WSuggestionPopup = function() { (" + s
	...
	static String wtjs2(WApplication app) {
		...
		if ("ctor.WSuggestionPopupStdMatcher".indexOf(".prototype") != -1) {
			return "Wt3_1_8.ctor.WSuggestionPopupStdMatcher = " + s + ";";
		} else {
			if ("ctor.WSuggestionPopupStdMatcher".substring(0, 5).compareTo(
				...
				return "Wt3_1_8.ctor.WSuggestionPopupStdMatcher = function() { ("
	...
	static String instantiateStdMatcher(WSuggestionPopup.Options options) {
		...
		s.append("new Wt3_1_8.WSuggestionPopupStdMatcher(").append(
