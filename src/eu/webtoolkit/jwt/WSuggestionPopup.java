...
public class WSuggestionPopup extends WPopupWidget {
	...
	public void setDefaultIndex(int row) {
		if (this.defaultValue_ != row) {
			...
			if (this.isRendered()) {
				this.doJavaScript(this.getJsRef() + ".wtObj.defaultValue = "
	...
	private void connectObjJS(final AbstractEventSignal s,
		...
		String jsFunction = "function(obj, event) {var o = " + this.getJsRef()
	...
	private void defineJavaScript() {
		...
		this.setJavaScriptMember(
				" WSuggestionPopup",
				"new Wt3_5_0.WSuggestionPopup(" + app.getJavaScriptClass()
	...
	static String instantiateStdMatcher(final WSuggestionPopup.Options options) {
		...
		s.append("new Wt3_5_0.WSuggestionPopupStdMatcher(")
