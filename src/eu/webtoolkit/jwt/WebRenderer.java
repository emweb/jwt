...
class WebRenderer implements SlotLearnerInterface {
  ...
  private void serveMainscript(final WebResponse response) throws IOException {
    ...
    script.setVar("WT_CLASS", "Wt4_10_1");
    ...
    if (this.session_.getType() == EntryPointType.WidgetSet) {
      ...
      if (!this.rendered_) {
        ...
        if (app.enableAjax_) {
          this.collectedJS1_
              .append("var form = Wt4_10_1.getElement('Wt-form'); if (form) {")
          ...
          this.collectedJS1_
              ...
              .append(';')
              .append("Wt4_10_1.progressed(domRoot);");
          ...
          this.collectedJS2_
              .append("Wt4_10_1.resolveRelativeAnchors();")
        ...
        out.append("Wt4_10_1.ready(function() { ")
            .append(app.getJavaScriptClass())
            .append("._p_.load(true);});\n");
      }
    }
