...
class WebRenderer implements SlotLearnerInterface {
  ...
  private void serveMainscript(final WebResponse response) throws IOException {
    ...
    if (serveSkeletons) {
      ...
      script.setVar("WT_CLASS", "Wt4_8_2");
    ...
    if (this.session_.getType() == EntryPointType.WidgetSet) {
      ...
      if (!this.rendered_) {
        ...
        if (app.enableAjax_) {
          this.collectedJS1_
              .append("var form = Wt4_8_2.getElement('Wt-form'); if (form) {")
          ...
          this.collectedJS1_
              ...
              .append(';')
              .append("Wt4_8_2.progressed(domRoot);");
          ...
          this.collectedJS2_
              .append("Wt4_8_2.resolveRelativeAnchors();")
