...
public class WSlider extends WCompositeWidget {
	...
	private void update() {
		...
		this.mouseDownJS_
				.setJavaScript("function(obj, event) {obj.setAttribute('down', Wt3_1_1.widgetCoordinates(obj, event)."
						+ u + "); Wt3_1_1.cancelEvent(event);}");
		String computeD = "var objh = " + this.handle_.getJsRef() + ",objb = "
				...
				+ ",d = u-w;";
		this.mouseMovedJS_
				.setJavaScript("function(obj, event) {var down = obj.getAttribute('down');var WT = Wt3_1_1;if (down != null && down != '') {"
						+ computeD
