...
public class WCanvasPaintDevice extends WObject implements WPaintDevice {
	...
	public void drawImage(final WRectF rect, final String imageUri,
		...
		this.js_.append("Wt3_5_1.gfxUtils.drawImage(ctx,images[")
	...
	public void drawPath(final WPainterPath path) {
		if (path.isJavaScriptBound()) {
			this.renderStateChanges(true);
			this.js_.append("Wt3_5_1.gfxUtils.drawPath(ctx,")
	...
	public void drawRect(final WRectF rectangle) {
		this.renderStateChanges(true);
		this.js_.append("Wt3_5_1").append(".gfxUtils.drawRect(ctx,")
	...
	public void drawText(final WRectF rect, EnumSet<AlignmentFlag> flags,
		...
		case Html5Text: {
			this.js_.append("Wt3_5_1.gfxUtils.drawText(ctx,")
					.append(rect.getJsRef()).append(',')
		...
		case MozText: {
			...
			if (this.currentPen_.isJavaScriptBound()) {
				this.js_.append("ctx.fillStyle=Wt3_5_1.gfxUtils.css_text(")
	...
	public void drawTextOnPath(final WRectF rect,
		...
		this.renderStateChanges(true);
		this.js_.append("Wt3_5_1.gfxUtils.drawTextOnPath(ctx,[");
	...
	public void render(final String paintedWidgetJsRef, final String canvasId,
		...
		String canvasVar = "Wt3_5_1.getElement('" + canvasId + "')";
		...
		if (this.paintUpdate_) {
			...
			tmp.append("pF=function(){").append(paintedWidgetJsRef)
					.append(".repaint();").append("};");
		}
		...
		tmp.append("],function(images){this.done = true;var o=")
				...
				.append(";if(o.imagePreloaders.length===0||this===o.imagePreloaders[0]){o.images=images;pF();o.imagePreloaders.shift();}else{while(o.imagePreloaders.length>0&&o.imagePreloaders[0].done){o.imagePreloaders[0].callback(o.imagePreloaders[0].images);}}});if(!l.done)o.imagePreloaders.push(l);}})();");
		...
		if (!EnumUtils.mask(this.changeFlags_,
			...
			if (clippingChanged) {
				...
				if (!p.isEmpty()) {
					...
					this.js_.append("Wt3_5_1").append(
			...
			if (penColorChanged) {
				...
				if (!this.getPainter().getPen().getGradient().isEmpty()) {
					...
					if (this.getPainter().getPen().isJavaScriptBound()) {
						this.js_.append(
								"ctx.strokeStyle=Wt3_5_1.gfxUtils.css_text(")
