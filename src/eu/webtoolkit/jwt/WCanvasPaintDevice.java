...
public class WCanvasPaintDevice extends WObject implements WPaintDevice {
  ...
  public void drawImage(
    ...
    this.js_
        .append("Wt4_8_3.gfxUtils.drawImage(ctx,images[")
  ...
  public void drawPath(final WPainterPath path) {
    if (path.isJavaScriptBound()) {
      this.renderStateChanges(true);
      this.js_
          .append("Wt4_8_3.gfxUtils.drawPath(ctx,")
  ...
  public void drawText(
    ...
    switch (this.textMethod_) {
      case Html5Text:
        {
          this.js_
              .append("Wt4_8_3.gfxUtils.drawText(ctx,")
              .append(rect.getJsRef())
              .append(',')
      ...
      case MozText:
        {
          ...
          if (this.currentPen_.isJavaScriptBound()) {
            this.js_
                .append("ctx.fillStyle=Wt4_8_3.gfxUtils.css_text(")
  ...
  public void drawTextOnPath(
    ...
    this.renderStateChanges(true);
    this.js_.append("Wt4_8_3.gfxUtils.drawTextOnPath(ctx,[");
  ...
  public void render(
    ...
    String canvasVar = "Wt4_8_3.getElement('" + canvasId + "')";
    ...
    if (this.changeFlags_.contains(PainterChangeFlag.Transform) || clippingChanged) {
      ...
      if (clippingChanged) {
        ...
        if (!p.isEmpty()) {
          ...
          this.js_.append("Wt4_8_3").append(".gfxUtils.removeClipPath(ctx);");
        }
      ...
      if (penColorChanged) {
        ...
        if (!this.getPainter().getPen().getGradient().isEmpty()) {
          ...
          if (this.getPainter().getPen().isJavaScriptBound()) {
            this.js_
                .append("ctx.strokeStyle=Wt4_8_3.gfxUtils.css_text(")
