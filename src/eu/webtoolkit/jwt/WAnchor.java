 ...
 * {@link WContainerWidget}). If you link to a document or external url, and do not want the
 * application to terminate when the user follows the anchor, you must use {@link
 * WAnchor#setTarget(AnchorTarget target) setTarget()}. Even for non-HTML documents, this may be
 ...
 * <p>
 *
 * <p><i><b>Note: </b>If you set a text or image using one of the API methods like {@link
 * WAnchor#setText(CharSequence text) setText()} or {@link WAnchor#setImage(WImage image)
 * setImage()} or a constructor, you should not attempt to remove all contents (using {@link
 * WContainerWidget#clear()}, or provide a layout (using {@link WContainerWidget#setLayout(WLayout
 * layout) WContainerWidget#setLayout()}), as this will result in undefined behaviour: the text or
 * image are simply inserted as widgets into the container.</i>
 *
 * <h3>CSS</h3>
 *
...
public class WAnchor extends WContainerWidget {
   ...
   * Creates an anchor.
   *
   * <p>Calls {@link #WAnchor(WContainerWidget parent) this((WContainerWidget)null)}
   */
  public WAnchor() {
   ...
   * Creates an anchor for the given link.
   *
   * <p>Calls {@link #WAnchor(WLink link, WContainerWidget parent) this(link,
   ...
   * <p>
   *
   * @deprecated Use {@link WAnchor#WAnchor(WLink link, WContainerWidget parent) WAnchor()} instead.
   */
   ...
   * Creates an anchor linking to a URL (<b>deprecated</b>).
   *
   * <p>Calls {@link #WAnchor(String ref, WContainerWidget parent) this(ref,
   * (WContainerWidget)null)}
   */
   ...
   *
   * <p>The <code>resource</code> specifies application-dependent content that may be generated by
   * your application on demand.
   *
   * <p>The anchor does not assume ownership of <code>resource</code>, so that you may share the
   * same resources for several anchors.
   *
   * <p>
   *
   * @deprecated Use {@link WAnchor#WAnchor(WLink link, WContainerWidget parent) WAnchor()} instead.
   ...
   * Creates an anchor linking to a resource (<b>deprecated</b>).
   *
   * <p>Calls {@link #WAnchor(WResource resource, WContainerWidget parent) this(resource,
   * (WContainerWidget)null)}
   */
   ...
   */
  public WAnchor(final WLink link, final CharSequence text, WContainerWidget parent) {
    super(parent);
    this.linkState_ = new WAnchor.LinkState();
    this.text_ = null;
    this.image_ = null;
   ...
   * Creates an anchor for the given link with a text.
   *
   * <p>Calls {@link #WAnchor(WLink link, CharSequence text, WContainerWidget parent) this(link,
   * text, (WContainerWidget)null)}
   */
   ...
   * <p>
   *
   * @deprecated Use {@link WAnchor#WAnchor(WLink link, CharSequence text, WContainerWidget parent)
   *     WAnchor()} instead.
   */
  public WAnchor(final String ref, final CharSequence text, WContainerWidget parent) {
    super(parent);
    this.linkState_ = new WAnchor.LinkState();
    this.text_ = null;
    this.image_ = null;
   ...
   * Creates an anchor linking to a URL with a text (<b>deprecated</b>).
   *
   * <p>Calls {@link #WAnchor(String ref, CharSequence text, WContainerWidget parent) this(ref,
   * text, (WContainerWidget)null)}
   */
   ...
   *     WAnchor()} instead.
   */
  public WAnchor(WResource resource, final CharSequence text, WContainerWidget parent) {
    super(parent);
    this.linkState_ = new WAnchor.LinkState();
    this.text_ = null;
    this.image_ = null;
   ...
   * Creates an anchor linking to a resource with a text (<b>deprecated</b>).
   *
   * <p>Calls {@link #WAnchor(WResource resource, CharSequence text, WContainerWidget parent)
   ...
   * Creates an anchor for the given link with an image.
   *
   * <p>Calls {@link #WAnchor(WLink link, WImage image, WContainerWidget parent) this(link, image,
   * (WContainerWidget)null)}
   */
   ...
   * <p>
   *
   * @deprecated Use {@link WAnchor#WAnchor(WLink link, WImage image, WContainerWidget parent)
   *     WAnchor()} instead.
   */
   ...
   * Creates an anchor linking to a URL with an image (<b>deprecated</b>).
   *
   * <p>Calls {@link #WAnchor(String ref, WImage image, WContainerWidget parent) this(ref, image,
   * (WContainerWidget)null)}
   */
  ...
  /**
   * Creates an anchor linking to a resource with an image (<b>deprecated</b>).
   *
   * <p>
   *
   * @deprecated Use {@link WAnchor#WAnchor(WLink link, WImage image, WContainerWidget parent)
   ...
   * Creates an anchor linking to a resource with an image (<b>deprecated</b>).
   *
   * <p>Calls {@link #WAnchor(WResource resource, WImage image, WContainerWidget parent)
   ...
   *
   * <p>When the link points to a {@link WLink.Type#Resource resource}, the contents of the link may
   * be generated by your application on demand.
   *
   * <p>When the link points to an {@link WLink.Type#InternalPath internal path}, activating the
   ...
   *
   * <p>The anchor does not assume ownership of the resource.
   *
   * <p>
   *
   * @deprecated Use {@link WAnchor#setLink(WLink link) setLink()} instead.
   ...
   *
   * <p>The default text format is XHTMLText.
   *
   * <p>
   *
   ...
   * WContainerWidget#addWidget(WWidget widget) WContainerWidget#addWidget()}.
   *
   * <p>Ownership of the image is transferred to the anchor.
   */
  ...
  static void renderUrlResolution(WWidget widget, final DomElement element, boolean all) {
    if (all) {
      element.setProperty(
          Property.PropertyClass, StringUtils.addWord(widget.getStyleClass(), "Wt-rr"));
    } else {
