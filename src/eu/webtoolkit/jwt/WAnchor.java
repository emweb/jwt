 ...
 * {@link WContainerWidget#setLayout(WLayout layout) setLayout() }), as this
 * will result in undefined behaviour. </i>
 * </p>
 */
public class WAnchor extends WContainerWidget {
   ...
   setRef(WApplication::instance()-&gt;bookmarkUrl(path)) 
	 ...
	 * <p>
	 * The {@link WInteractWidget#clicked() WInteractWidget#clicked() } signal
	 * is connected to a slot that changes the internal path by calling <code>
   WApplication::instance()-&gt;setInternalPath(ref(), true);
	 ...
	 * alternative to {@link WAnchor#setRef(String ref) setRef() }. The resource
	 * may be cleared by passing <i>resource</i> = 0.
	 * <p>
	 * The anchor does not assume ownership of the resource.
	 * <p>
	 * 
	 ...
	 * over multiple lines. When <i>on</i> is false, the text will displayed on
	 * a single line, unless the text contains &lt;br /&gt; tags or other
	 * block-level tags.
	 * <p>
