  ...
  public static void applyIfNeeded(WWidget w) {
    if (w.getJavaScriptMember(WWidget.WT_RESIZE_JS).length() != 0) {
      ...
      w.setJavaScriptMember(
          " ResizeSensor", "new Wt4_12_2.ResizeSensor(Wt4_12_2," + w.getJsRef() + ")");
    }
  }
