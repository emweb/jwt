...
public class WidgetThemeRole {
  ...
  public static final int NavbarSearch = 803;
  public static final int NavbarMenu = 804;
  public static final int NavbarBtn = 805;
  public static final int NavbarAlignLeft = 806;
  public static final int NavbarAlignRight = 807;
}
