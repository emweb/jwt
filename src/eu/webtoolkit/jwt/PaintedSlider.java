...
class PaintedSlider extends WPaintedWidget {
	...
	public void updateState() {
		...
		this.mouseDownJS_
				.setJavaScript("function(obj, event) {obj.setAttribute('down', Wt3_1_11.widgetCoordinates(obj, event)."
						+ u + "); Wt3_1_11.cancelEvent(event);}");
		String computeD = "var objh = " + this.handle_.getJsRef() + ",objb = "
				...
				+ ",d = u-w;";
		this.mouseMovedJS_
				.setJavaScript("function(obj, event) {var down = obj.getAttribute('down');var WT = Wt3_1_11;if (down != null && down != '') {"
						+ computeD
