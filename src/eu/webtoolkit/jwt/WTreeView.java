...
public class WTreeView extends WAbstractItemView {
		...
		if (count != 0 && !(oldCount != 0)) {
			...
			if (useStyleLeft) {
				...
				this.tieRowsScrollJS_
						.setJavaScript("function(obj, event) {Wt3_1_9.getCssRule('#"
								+ this.getId()
	...
	private void defineJavaScript() {
		...
		app.doJavaScript("new Wt3_1_9.WTreeView(" + app.getJavaScriptClass()
				+ "," + this.getJsRef() + ","
	...
	static String wtjs1(WApplication app) {
		...
		if ("ctor.WTreeView".indexOf(".prototype") != -1) {
			return "Wt3_1_9.ctor.WTreeView = " + s + ";";
		} else {
			if ("ctor.WTreeView".substring(0, 5).compareTo(
					"ctor.".substring(0, 5)) == 0) {
				return "Wt3_1_9." + "ctor.WTreeView".substring(5) + " = " + s
						+ ";";
			} else {
				return "Wt3_1_9.ctor.WTreeView = function() { (" + s
