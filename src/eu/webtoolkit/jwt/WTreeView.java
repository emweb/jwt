...
public class WTreeView extends WAbstractItemView {
		...
		if (count != 0 && !(oldCount != 0)) {
			...
			if (useStyleLeft) {
				...
				this.tieRowsScrollJS_
						.setJavaScript("function(obj, event) {Wt3_2_1.getCssRule('#"
								+ this.getId()
	...
	private void defineJavaScript() {
		...
		app.doJavaScript("new Wt3_2_1.WTreeView(" + app.getJavaScriptClass()
				+ "," + this.getJsRef() + ","
