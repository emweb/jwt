...
public abstract class WInteractWidget extends WWebWidget {
  ...
  public void setPopup(boolean popup) {
    if (popup && WApplication.getInstance().getEnvironment().hasAjax()) {
      this.clicked()
          .addListener(
              "function(o,e) {  if (Wt4_7_0.WPopupWidget && o.wtPopup) {Wt4_7_0.WPopupWidget.popupClicked = o;$(document).trigger('click', e);Wt4_7_0.WPopupWidget.popupClicked = null; }}");
  ...
  void updateDom(final DomElement element, boolean all) {
    ...
    if (updateMouseMove) {
      ...
      if (mouseDrag != null) {
        actions.add(
            new DomElement.EventAction(
                "Wt4_7_0.buttons",
                mouseDrag.getJavaScript() + "Wt4_7_0.drag(e);",
                mouseDrag.encodeCmd(),
    ...
    if (updateMouseClick) {
      ...
      js.append(CheckDisabled);
      if (mouseDrag != null) {
        js.append("if (Wt4_7_0.dragged()) return;");
      }
      if (mouseDblClick != null && mouseDblClick.needsUpdate(all)) {
        if (mouseClick != null) {
          if (mouseClick.isDefaultActionPrevented() || mouseClick.isPropagationPrevented()) {
            js.append("Wt4_7_0.cancelEvent(e");
            if (mouseClick.isDefaultActionPrevented() && mouseClick.isPropagationPrevented()) {
              js.append(");");
            } else {
        ...
        js.append("if(Wt4_7_0.isDblClick(o, e)) {").append(mouseDblClick.getJavaScript());
        ...
        js.append(
            "}else{if (Wt4_7_0.isIElt9 && document.createEventObject) e = document.createEventObject(e);o.wtE1 = e;o.wtClickTimeout = setTimeout(function() {o.wtClickTimeout = null; o.wtE1 = null;");
        if (mouseClick != null) {
