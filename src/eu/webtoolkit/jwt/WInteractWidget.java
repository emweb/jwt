...
public abstract class WInteractWidget extends WWebWidget {
	...
	void updateDom(final DomElement element, boolean all) {
		...
		if (updateMouseMove) {
			...
			if (mouseDrag != null) {
				actions.add(new DomElement.EventAction("Wt3_5_2.buttons",
		...
		if (updateMouseClick) {
			...
			if (mouseDblClick != null && mouseDblClick.needsUpdate(all)) {
				...
				js.append("if(Wt3_5_2.isDblClick(o, e)) {").append(
				...
				js.append("}else{if (Wt3_5_2.isIElt9 && document.createEventObject) e = document.createEventObject(e);o.wtE1 = e;o.wtClickTimeout = setTimeout(function() {o.wtClickTimeout = null; o.wtE1 = null;");
				if (mouseClick != null) {
