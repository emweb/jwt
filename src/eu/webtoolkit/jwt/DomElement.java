...
public class DomElement {
  ...
  public void setEvent(
    ...
    if (isExposed || anchorClick || jsCode.length() != 0) {
      ...
      js.append("o=this;");
      if (anchorClick) {
        js.append("if(e.ctrlKey||e.metaKey||(Wt4_6_0.button(e) > 1))return true;else{");
      }
      js.append(jsCode);
      if (isExposed) {
  ...
  public void callMethod(final String method) {
    ...
    if (this.var_.length() == 0) {
      this.javaScript_.append("Wt4_6_0").append(".$('").append(this.id_).append("').");
    } else {
  ...
  public void removeFromParent() {
    this.callJavaScript("Wt4_6_0.remove('" + this.getId() + "');", true);
  }
      ...
      case Delete:
        if (this.javaScriptEvenWhenDeleted_.length() != 0 || this.removeAllChildren_ >= 0) {
          ...
          if (this.removeAllChildren_ >= 0) {
            this.declare(out);
            if (this.removeAllChildren_ == 0) {
              out.append("Wt4_6_0").append(".setHtml(").append(this.var_).append(", '');\n");
            } else {
              out.append("$(")
                  .append(this.var_)
                  .append(").children(':gt(")
      ...
      case Update:
        {
          ...
          if (this.mode_ == DomElement.Mode.Update && this.numManipulations_ == 1) {
            ...
            if (this.properties_.get(Property.StyleDisplay) != null) {
              ...
              if (style.equals("none")) {
                out.append("Wt4_6_0.hide('").append(this.id_).append("');\n");
                return this.var_;
              } else {
                if (style.equals("inline")) {
                  out.append("Wt4_6_0.inline('" + this.id_ + "');\n");
                  return this.var_;
                } else {
                  if (style.equals("block")) {
                    out.append("Wt4_6_0.block('" + this.id_ + "');\n");
                    return this.var_;
                  } else {
                    out.append("Wt4_6_0.show('")
                        .append(this.id_)
                        .append("', '")
                        .append(style)
                        .append("');\n");
          ...
          if (this.unwrapped_) {
            out.append("Wt4_6_0.unwrap('").append(this.id_).append("');\n");
          }
          ...
          if (!this.childrenToSave_.isEmpty()) {
            this.declare(out);
            out.append("Wt4_6_0").append(".saveReparented(").append(this.var_).append(");");
          }
          ...
          for (int i = 0; i < this.childrenToSave_.size(); ++i) {
            out.append("Wt4_6_0.replaceWith('")
                .append(this.childrenToSave_.get(i))
                .append("',c")
                .append(this.var_)
                .append((int) i)
    ...
    if (this.minMaxSizeProperties_ && app.getEnvironment().getAgent() == UserAgent.IE6) {
      ...
      if (minw != null || maxw != null) {
        if (w == null) {
          ...
          expr.append("Wt4_6_0.IEwidth(this,");
          if (minw != null) {
    ...
    for (Iterator<Map.Entry<Property, String>> i_it = this.properties_.entrySet().iterator();
      ...
      switch (i.getKey()) {
        ...
        case AddedInnerHTML:
          ...
          out.append("Wt4_6_0.setHtml(").append(this.var_).append(',');
          if (!pushed) {
