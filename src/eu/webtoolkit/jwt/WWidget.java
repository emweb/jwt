...
public abstract class WWidget extends WObject {
	...
	public void positionAt(WWidget widget, Orientation orientation) {
		...
		String side = orientation == Orientation.Horizontal ? ".Horizontal"
				: ".Vertical";
		this.doJavaScript("Wt3_3_11.positionAtWidget('" + this.getId() + "','"
				+ widget.getId() + "',Wt3_3_11" + side + ");");
	}
	 ...
	 * are rendered immediately, and invisible widgets in the back-ground (or
	 * not for a plain HTML session). This method is called when the widget is
