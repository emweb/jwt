...
public class WFileDropWidget extends WContainerWidget {
  ...
  String renderRemoveJs(boolean recursive) {
    if (this.isRendered()) {
      ...
      if (!recursive) {
        result += "Wt4_7_3.remove('" + this.getId() + "');";
      }
      return result;
    } else {
