...
public class WTextEdit extends WTextArea {
	...
	String renderRemoveJs() {
		if (this.isRendered()) {
			return this.getJsRef() + ".ed.remove();Wt3_3_0.remove('"
					+ this.getId() + "');";
		} else {
	...
	private void init() {
		...
		this.setJavaScriptMember(" WTextEdit", "new Wt3_3_0.WTextEdit("
