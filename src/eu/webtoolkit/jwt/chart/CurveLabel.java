...
public class CurveLabel {
	 ...
	 * and the given text.
	 */
	public CurveLabel(final WDataSeries series, final Object x, final Object y,
			final String label) {
		this.series_ = series;
		this.x_ = x;
		this.y_ = y;
	 ...
	 * will perform no conversion, so they may be safer to use.</i>
	 * </p>
	 * 
	 * @see CurveLabel#setPoint(WPointF point)
	 */
	public WPointF getPoint() {
		return new WPointF(StringUtils.asNumber(this.x_),
				StringUtils.asNumber(this.y_));
	}
