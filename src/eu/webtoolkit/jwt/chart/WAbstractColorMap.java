 ...
 * <p>
 * 
 * The colormap has functionality to convert a numerical value to a
 * {@link WColor}. For details on how, see the documentation of the
 * implementations.
 * <p>
...
public abstract class WAbstractColorMap extends WObject {
	 ...
	 * Paints the colormap as a colored strip.
	 * <p>
	 * Calls {@link #createStrip(WPainter painter, WRectF area)
	 ...
	 * Paints the colormap as a legend.
	 * <p>
	 * Calls {@link #paintLegend(WPainter painter, WRectF area)
	 ...
	 * For example, the default value of 2 will leave two line-heights between
	 ...
	 * <p>
	 * The default is a default constructed {@link WFont}.
	 * <p>
	 * 
	 * @see WAbstractColorMap#paintLegend(WPainter painter, WRectF area)
	 */
