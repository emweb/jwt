...
class StdWidgetItemImpl extends StdLayoutItemImpl {
  ...
  void containerAddWidgets(WContainerWidget container) {
    if (container != null) {
      ...
      WContainerWidget wc =
          ((this.item_.getWidget().getParent()) instanceof WContainerWidget
              ? (WContainerWidget) (this.item_.getWidget().getParent())
              : null);
      if (wc != null) {
  ...
  public DomElement createDomElement(boolean fitWidth, boolean fitHeight, WApplication app) {
    ...
    if (app.getEnvironment().agentIsIElt(9)
        && (d.getType() == DomElementType.DomElement_TEXTAREA
            ...
            || d.getType() == DomElementType.DomElement_BUTTON)) {
