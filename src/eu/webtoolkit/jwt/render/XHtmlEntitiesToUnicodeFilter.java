...
class XHtmlEntitiesToUnicodeFilter implements IXMLBuilder, IXMLEntityResolver {
 	private static Map<String, Integer> xhtmlEntities = new HashMap<String, Integer>();
	...
	public XHtmlEntitiesToUnicodeFilter() {
		super();
	}
