    ...
    password2
        ...
        .addListener(
            "function(o) {var i="
                ...
                + ",o1="
                + password.getJsRef()
                + ";if (!o1.classList.contains('Wt-invalid')) {if (o.value == o1.value) {o.classList.remove('Wt-invalid');Wt4_9_0.setHtml(i,"
                + WString.toWString(WString.tr("Wt.Auth.valid")).getJsStringLiteral()
                + ");} else {o.classList.remove('Wt-valid');Wt4_9_0.setHtml(i,"
