...
public class LostPasswordWidget extends WTemplate {
  ...
  public LostPasswordWidget(
      final AbstractUserDatabase users, final AuthService auth, WContainerWidget parent) {
   ...
   * WContainerWidget parent) this(users, auth, (WContainerWidget)null)}
   */
