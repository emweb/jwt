...
public class WTemplate extends WInteractWidget {
	 ...
	 * <p>
	 * The widget is reparented to the {@link WTemplate}, so that it is deleted
	 * when the {@link WTemplate} is deleted.
	 * <p>
	...
	private void unrenderWidget(WWidget w, final DomElement el) {
		...
		if (removeJs.charAt(0) == '_') {
			el.callJavaScript("Wt3_3_11.remove('" + removeJs.substring(1)
					+ "');", true);
		} else {
