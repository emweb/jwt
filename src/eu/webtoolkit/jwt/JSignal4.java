 ...
 * <p>
 * The argument types A1 to A4 must be a {@link String}, {@link WString} or a wrapper class
 ...
 * 
 * <pre>
 *   JSignal4&lt;String, Integer, Double, Integer&gt; pingSignal
 *      = new JSignal4&lt;String, Integer, Double, Integer&gt;(this, "pingSignal") { };
 * </pre>
 * 
 * For a usage example take a look the documentation of {@link JSignal2}.
 */
public abstract class JSignal4<A1, A2, A3, A4> extends AbstractJSignal {
	 ...
	 */
	public JSignal4(WObject sender, String name) {
	 ...
	 */
	public Connection addListener(WObject listenerOwner, Signal4.Listener<A1, A2, A3, A4> listener) {
		if (dynamic_ == null)
			dynamic_ = new Signal4<A1, A2, A3, A4>(getSender());
	 ...
	 */
	public void removeListener(Signal4.Listener<A1, A2, A3, A4> listener) {
		if (dynamic_ != null)
	...
	public void trigger(A1 arg1, A2 arg2, A3 arg3, A4 arg4) {
		if (dynamic_ != null)
			dynamic_.trigger(arg1, arg2, arg3, arg4);
	 ...
	 */
	public String createCall(String arg1, String arg2, String arg3, String arg4) {
		return createUserEventCall(null, null, arg1, arg2, arg3, arg4, null, null);
	}
