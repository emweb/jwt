...
public class WTableView extends WAbstractItemView {
	...
	private void defineJavaScript() {
		...
		StringBuilder s = new StringBuilder();
		s.append("new Wt3_3_12.WTableView(").append(app.getJavaScriptClass())
