...
public class WTableView extends WAbstractItemView {
	...
	private void defineJavaScript() {
		...
		app.doJavaScript("new Wt3_1_9.WTableView(" + app.getJavaScriptClass()
				+ "," + this.getJsRef() + ","
	...
	static String wtjs1(WApplication app) {
		...
		if ("ctor.WTableView".indexOf(".prototype") != -1) {
			return "Wt3_1_9.ctor.WTableView = " + s + ";";
		} else {
			if ("ctor.WTableView".substring(0, 5).compareTo(
					"ctor.".substring(0, 5)) == 0) {
				return "Wt3_1_9." + "ctor.WTableView".substring(5) + " = " + s
						+ ";";
			} else {
				return "Wt3_1_9.ctor.WTableView = function() { (" + s
