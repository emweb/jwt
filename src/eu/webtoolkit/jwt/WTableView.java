...
public class WTableView extends WAbstractItemView {
	...
	private void defineJavaScript() {
		...
		app.doJavaScript("new Wt3_1_7.WTableView(" + app.getJavaScriptClass()
				+ "," + this.getJsRef() + ","
