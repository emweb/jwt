...
public class WTableView extends WAbstractItemView {
	...
	public WTableView(WContainerWidget parent) {
		...
		this.itemTouchEvent_ = new JSignal1<WTouchEvent>(this.impl_,
				"itemTouchEvent") {
		};
		this.firstColumn_ = -1;
		this.lastColumn_ = -1;
	...
	private JSignal1<WTouchEvent> itemTouchEvent_;
