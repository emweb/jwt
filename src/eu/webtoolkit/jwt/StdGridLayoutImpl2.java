...
class StdGridLayoutImpl2 extends StdLayoutImpl {
	...
	static WJavaScriptPreamble appjs1() {
		return new WJavaScriptPreamble(
				...
				"layouts2",
				"new (function(){var D=[],B=false,I=this,L=false;this.find=function(r){return jQuery.data(document.getElementById(r),\"layout\")};this.setDirty=function(r){(r=jQuery.data(r,\"layout\"))&&r.setDirty()};this.setChildLayoutsDirty=function(r,E){var y,w;y=0;for(w=r.descendants.length;y<w;++y){var v=r.descendants[y];if(E){var z=r.WT.getElement(v.getId());if(z&&!r.WT.contains(E,z))continue}v.setDirty()}};this.add=function(r){function E(y,w){var v,z;v=0;for(z= y.length;v<z;++v){var u=y[v];if(u.getId()==w.getId()){y[v]=w;w.descendants=u.descendants;return}else if(u.contains(w)){E(u.descendants,w);return}else if(w.contains(u)){w.descendants.push(u);y.splice(v,1);--v;--z}}y.push(w)}E(D,r);I.scheduleAdjust()};var Q=false;this.scheduleAdjust=function(){if(!Q){Q=true;setTimeout(function(){I.adjust()},0)}};this.adjust=function(r,E){function y(v,z){var u,J;u=0;for(J=v.length;u<J;++u){var H=v[u];y(H.descendants,z);z==1&&L&&H.setDirty();H.measure(z)}}function w(v, z){var u,J;u=0;for(J=v.length;u<J;++u){var H=v[u];if(H.apply(z))w(H.descendants,z);else{v.splice(u,1);--u;--J}}}if(r){(r=this.find(r))&&r.setItemsDirty(E);I.scheduleAdjust()}else{Q=false;if(!B){B=true;y(D,0);w(D,0);y(D,1);w(D,1);L=B=false}}};this.updateConfig=function(r,E){(r=this.find(r))&&r.setConfig(E)};window.onresize=function(){L=true;I.scheduleAdjust()};window.onshow=function(){L=true;I.adjust()}})");
	}
