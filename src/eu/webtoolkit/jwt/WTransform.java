...
public class WTransform extends WJavaScriptExposableObject {
  ...
  public WPointF map(final WPointF p) {
    ...
    if (this.isJavaScriptBound() || p.isJavaScriptBound()) {
      ...
      result.assignBinding(
          o, "Wt4_11_4.gfxUtils.transform_mult(" + this.getJsRef() + ',' + p.getJsRef() + ')');
    }
    return result;
  }
  /**
  ...
  public WRectF map(final WRectF rect) {
    ...
    if (this.isJavaScriptBound() || rect.isJavaScriptBound()) {
      ...
      result.assignBinding(
          o, "Wt4_11_4.gfxUtils.transform_mult(" + this.getJsRef() + ',' + rect.getJsRef() + ')');
    }
    return result;
  }
  /**
  ...
  public WPainterPath map(final WPainterPath path) {
    ...
    if (this.isJavaScriptBound() || path.isJavaScriptBound()) {
      ...
      result.assignBinding(
          o, "Wt4_11_4.gfxUtils.transform_apply(" + this.getJsRef() + ',' + path.getJsRef() + ')');
    }
  ...
  public WTransform translate(final WPointF p) {
    ...
    if (this.isJavaScriptBound() || p.isJavaScriptBound()) {
      ...
      if (identity) {
        ...
        this.assignBinding(
            o,
            "Wt4_11_4.gfxUtils.transform_mult((function(){var p="
                + p.getJsRef()
  ...
  public WTransform multiplyAndAssign(final WTransform Y) {
    ...
    if (this.isJavaScriptBound() || Y.isJavaScriptBound()) {
      ...
      this.assignBinding(
          o, "Wt4_11_4.gfxUtils.transform_mult(" + this.getJsRef() + ',' + Y.getJsRef() + ')');
    }
  ...
  public WTransform getAdjoint() {
    ...
    if (this.isJavaScriptBound()) {
      res.assignBinding(this, "Wt4_11_4.gfxUtils.transform_adjoint(" + this.getJsRef() + ")");
    }
    return res;
  }
  /**
    ...
    if (det != 0) {
      ...
      WTransform res =
          new WTransform(
              ...
              adj.getM32() / det);
      if (this.isJavaScriptBound()) {
        res.assignBinding(this, "Wt4_11_4.gfxUtils.transform_inverted(" + this.getJsRef() + ")");
      }
      return res;
    } else {
