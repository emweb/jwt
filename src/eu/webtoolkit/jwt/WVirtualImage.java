...
public class WVirtualImage extends WCompositeWidget {
	...
	public void enableDragging() {
		this.impl_
				.mouseWentDown()
				.addListener(
						"function(obj, event) {  var pc = Wt3_5_1.pageCoordinates(event);  obj.setAttribute('dsx', pc.x);  obj.setAttribute('dsy', pc.y);}");
		this.impl_
				.mouseMoved()
				.addListener(
						"function(obj, event) {var WT= Wt3_5_1;var lastx = obj.getAttribute('dsx');var lasty = obj.getAttribute('dsy');if (lastx != null && lastx != '') {var nowxy = WT.pageCoordinates(event);var img = "
