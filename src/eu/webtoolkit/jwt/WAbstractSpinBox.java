...
public abstract class WAbstractSpinBox extends WLineEdit {
	...
	private void defineJavaScript() {
		...
		String jsObj = "new Wt3_1_9.WSpinBox(" + app.getJavaScriptClass() + ","
