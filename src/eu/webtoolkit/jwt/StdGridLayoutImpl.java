				...
				app
						.declareJavaScriptFunction(
								...
								"function(){var a="
										...
										+ ".layoutTableObjs;var i;for(i=0;i<a.length;++i){var id=a[i][0];var c=a[i][1];var mh=a[i][2];var w=Wt3_1_1.getElement(id);if(!w){Wt3_1_1.arrayRemove(a, i);--i;}else{Wt3_1_1.layoutAdjust(w,c,mh);}}}");
