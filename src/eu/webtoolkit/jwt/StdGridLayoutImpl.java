...
class StdGridLayoutImpl extends StdLayoutImpl {
	...
	public DomElement createDomElement(boolean fitWidth, boolean fitHeight,
		...
		if (fitHeight) {
			...
			layoutAdd.append(app.getJavaScriptClass()).append(
					".layouts.add(new Wt3_1_7a.StdLayout( Wt3_1_7a, '").append(
	...
	public static String getChildrenResizeJS() {
		...
		return "Wt3_1_7a.ChildrenResize";
	}
	...
	static String wtjs10(WApplication app) {
		return "Wt3_1_7a.ChildrenResize = function(b,f,d){var c,e,a;b.style.height=d+\"px\";c=0;for(e=b.childNodes.length;c<e;++c){a=b.childNodes[c];if(a.nodeType==1)if(a.wtResize)a.wtResize(a,f,d);else if(a.style.height!=b.style.height)a.style.height=b.style.height}};";
	}
}
