				...
				app
						.declareJavaScriptFunction(
								...
								"function(){var a="
										...
										+ ".layoutTableObjs;var i;for(i=0;i<a.length;++i){var id=a[i][0];var c=a[i][1];var mh=a[i][2];var w=Wt2_99_5.getElement(id);if(!w){Wt2_99_5.arrayRemove(a, i);--i;}else{Wt2_99_5.layoutAdjust(w,c,mh);}}}");
