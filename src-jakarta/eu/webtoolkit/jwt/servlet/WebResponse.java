...
public class WebResponse extends HttpServletResponseWrapper {
	...
	public WebResponse(final OutputStream out) {
		...
		this.outputStream = new ErrorSuppressingOutputStream(new ServletOutputStream() {
			@Override
	...
	public ServletOutputStream getOutputStream() {
		try {
			if (outputStream == null)
				outputStream = new ErrorSuppressingOutputStream(super.getOutputStream(), logger);
			return outputStream;
		} catch (IOException e) {
			logger.error("Failed to retrieve ServletOutputStream: {}", e.getMessage());
			return new ErrorSuppressingOutputStream();
		}
	}
	...
	private static class ErrorSuppressingOutputStream extends ServletOutputStream {
